...
<template>
  <div
    class="min-h-screen bg-linear-to-br from-black via-gray-900 to-gray-800 flex items-center justify-center p-4"
  >
    <div class="w-full max-w-md bg-white rounded-3xl shadow-2xl p-10">
      <h1 class="text-4xl font-black text-center mb-3">InsureFlow</h1>
